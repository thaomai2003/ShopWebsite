                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="./admin/user" class="{{(request()->segment(2)=='user') ? 'mn-active' : ''}}">
                                        <i class="metismenu-icon"></i>User
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/order" class="{{(request()->segment(2)=='order') ? 'mn-active' : ''}}">
                                        <i class="metismenu-icon"></i>Order
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/product" class="{{(request()->segment(2)=='product') ? 'mn-active' : ''}}">
                                        <i class="metismenu-icon"></i>Product
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/category" class="{{(request()->segment(2)=='category') ? 'mn-active' : ''}}">
                                        <i class="metismenu-icon"></i>Category
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/brand" class="{{(request()->segment(2)=='brand') ? 'mn-active' : ''}}">
