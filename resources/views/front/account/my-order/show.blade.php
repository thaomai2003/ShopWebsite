            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input disabled type="text" id="street" value="{{$order->street_address}}" class="">
                    </div>
                    <div class="col-lg-12">
                        <label for="zip">Post_code / Zip (optional)</label>
                            ...
                            @foreach($order->orderDetails as $orderDetail)
                                <li class="fw-formal">
                                   {{$orderDetail->product->name}} x {{$orderDetail->qty}}
                                    <span>${{$orderDetail->total}}.00</span>
                                </li>
                            @endforeach
                            <li class="total-price">
                                Total
                                <span>${{ array_sum(array_column($order->orderDetails->toArray(),'total'))}}.00</span>
                            </li>
                        </ul>
