            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <a href="../../../../../../Đồ%20án/frontend/index.html"><i class="fa fa-home"></i>Home</a>
                        <span>Shop</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-7 col-md-7">
                            ...
                            <div class="select-option">
                                <select name="sort_by" onchange="this.form.submit();" class="sorting">
                                    ...
                                    <option {{ request('sort_by') == 'name-descending' ? 'selected' : '' }} value="name-descending">Sorting : Name : X-A</option>
